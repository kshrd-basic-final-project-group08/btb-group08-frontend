    ...
    return (
        <form className="">
            <div className="flex relative w-27 group">
                ...
                <div className="bg-white shadow-2xl rounded h-0 overflow-hidden translate-y-3 group-hover:translate-y-0 transition-all group-hover:h-fit flex absolute bg-red-500 top-full left-0 flex flex-col w-full">
